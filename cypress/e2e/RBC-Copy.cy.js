    ...
    describe("Add valid data", function () {
        ...
        // [[375 ,	812],[812 , 375], [320 , 568], [568 , 320] ,  [2279,1938], [360,740], [740 , 360]].forEach(viewport => {   // [1536 , 864] is our desktop dimensions
            ...
            // Page 1
                ...
                //cy.wait(1500);
                cy.get('#input_70_7',  { timeout: 60000 }).type(user[i].Lastname).should('be.visible')
                .invoke('text')
                .should('be.a', 'string')
                .should('contain', /^[0-9]*$/)
                // .and('be.not.empty');
                //cy.wait(1500);
                cy.get('#input_70_8',  { timeout: 60000 }).type(user[i].Firstname).should('be.visible')
                .invoke('text')
                .should('be.a', 'string')
                .should('contain', /^[0-9]*$/)
                //cy.wait(1500);
                cy.get('#input_70_589',  { timeout: 60000 }).type(user[i].Middlename).should('be.visible')
                .invoke('text')
                .should('be.a', 'string')
                .should('contain', /^[0-9]*$/)
                //cy.wait(1500);
                ...
                cy.get(Smoking).check();
                //cy.wait(1500);
                var EnglishFrench = user[i].EnglishFrench;
                cy.get(EnglishFrench).check();
                //cy.wait(1500);
...
//*******   // if No, add an assertion to have text
                ...
                cy.get(FrenchPolicy).check();
                //cy.wait(1500);

                var Residency = user[i].Residency
                cy.get(Residency).check();
...
//******* if Other, "Please Specify" should appear (Add assertion) add a condition to enter this field
            ...
            // Page 2
                ...
                cy.get(LifeCoverage).should('be.visible').check();
//******* if Yes, add a condition
                if( LifeCoverage == '#choice_70_63_0'){
                    ...
                    cy.get(IntendedInsurance).check();
                }  
